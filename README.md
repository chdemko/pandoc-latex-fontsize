...
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-latex-fontsize/1.0.0.svg)](https://travis-ci.org/chdemko/pandoc-latex-fontsize/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-fontsize/1.0.0.svg)](https://coveralls.io/github/chdemko/pandoc-latex-fontsize?branch=1.0.0)
...
[![PyPI format](https://img.shields.io/pypi/format/pandoc-latex-fontsize/1.0.0.svg)](https://pypi.org/project/pandoc-latex-fontsize/1.0.0/)
[![License](https://img.shields.io/pypi/l/pandoc-latex-fontsize/1.0.0.svg)](https://raw.githubusercontent.com/chdemko/pandoc-latex-fontsize/1.0.0/LICENSE)
